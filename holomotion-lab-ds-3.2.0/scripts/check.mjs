...
const required = [
  ...
  "src/face-engine.js", "tests/gesture-engine.test.mjs", "tests/shape-game.test.mjs", "tests/versioning.test.mjs", "tests/app-catalog.test.mjs", "downloads/LabVirtualDS-VR-v0.3.3.apk", ".nojekyll"
];
