...
export const APP_CATALOG = Object.freeze([
  ...
  {
    id: "motion-checklist-web",
    name: "Motion Checklist",
    shortName: "Tutorial validado",
    icon: "✓",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    availability: "available",
    category: "sensors",
    tags: ["sensors", "education", "games", "web", "offline"],
    versionKey: "checklist",
    description: "Tutorial etapa por etapa com checklist de mão, dedos, corpo, rosto, sustentação e correções em tempo real.",
    summary: "Aprenda como a plataforma reconhece cada movimento.",
    requirements: ["Câmera", "Boa iluminação", "Espaço para movimentos"],
    action: { type: "mode", value: "checklist", label: "Iniciar tutorial" }
  },
  {
    id: "simon-motion-web",
    name: "Simon Motion",
    shortName: "Memória corporal",
    icon: "◫",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    availability: "available",
    category: "games",
    tags: ["games", "sensors", "web", "offline"],
    versionKey: "simon",
    description: "Memorize e reproduza sequências crescentes de gestos das mãos e movimentos corporais.",
    summary: "Jogo de memória controlado pelo corpo.",
    requirements: ["Câmera", "Corpo enquadrado"],
    action: { type: "mode", value: "simon", label: "Jogar Simon Motion" }
  },
  {
    id: "reflex-challenge-web",
    name: "Reflex Challenge",
    shortName: "Reflexo por gestos",
    icon: "⚡",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    ...
    tags: ["games", "sensors", "web", "offline"],
    versionKey: "reflex",
    description: "Execute rapidamente o comando exibido e ganhe bônus de velocidade, combo e XP.",
    summary: "Desafio de reação com gestos e corpo.",
    requirements: ["Câmera", "Boa iluminação"],
    action: { type: "mode", value: "reflex", label: "Iniciar desafio" }
  },
  {
    id: "gesture-marathon-web",
    name: "Gesture Marathon",
    shortName: "Maratona de movimentos",
    icon: "∞",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    ...
    tags: ["games", "sensors", "web", "offline"],
    versionKey: "marathon",
    description: "Complete movimentos consecutivos, recupere energia e alcance uma sequência longa sem interrupções.",
    summary: "Resistência, precisão e combos corporais.",
    requirements: ["Câmera", "Espaço para movimentos"],
    action: { type: "mode", value: "marathon", label: "Iniciar maratona" }
  },
  {
    id: "holo-defender-web",
    name: "Holo Defender",
    shortName: "Escudos holográficos",
    icon: "◉",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    availability: "available",
    category: "games",
    tags: ["games", "sensors", "hologram", "web", "offline"],
    versionKey: "defender",
    description: "Abra as mãos para criar escudos, feche-as para disparar e use o corpo para bloquear ataques.",
    summary: "Defesa holográfica por mãos e postura.",
    requirements: ["Câmera", "Mãos e tronco visíveis"],
    action: { type: "mode", value: "defender", label: "Iniciar defesa" }
  },
  {
    id: "face-reactor-web",
    name: "Face Reactor",
