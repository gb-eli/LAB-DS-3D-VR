...
A versão 4.5.0 remove o antigo limite máximo fixo de 30 FPS. A plataforma passa a solicitar o valor escolhido ou recomendado. O valor real deve ser conferido em `MediaStreamTrack.getSettings()`.
