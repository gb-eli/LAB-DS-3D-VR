...
export const APP_CATALOG = Object.freeze([
  {
    ...
    versionKey: "explorer",
    description: "Explore nove maquetes procedurais em modo livre, visita guiada, desafio ou Holo Quiz, selecionando partes diretamente no holograma.",
    summary: "Atividades guiadas, minijogos, quiz, peças selecionáveis e XP.",
    requirements: ["Navegador moderno", "WebGL", "Câmera opcional"],
    action: { type: "mode", value: "explorer", label: "Abrir Holo Explorer Advanced" }
  },
  {
    id: "holo-blocks-web",
    name: "Holo Blocks",
    shortName: "Blocos holográficos",
    icon: "▦",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    availability: "available",
    category: "hologram",
    tags: ["hologram", "games", "education", "web", "offline"],
    versionKey: "blocks",
    description: "Construa cenários 3D com terra, água, lava, gelo, cristal, metal e outros blocos, descobrindo reações entre materiais.",
    summary: "Construção voxel, reações, gestos, mouse, toque, pontuação e XP.",
    requirements: ["Navegador moderno", "WebGL", "Câmera opcional"],
    action: { type: "mode", value: "blocks", label: "Abrir Holo Blocks" }
  },
  {
    id: "holo-assembly-web",
    name: "Holo Assembly",
    shortName: "Montagem holográfica",
    icon: "⌘",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    ...
    tags: ["hologram", "games", "education", "web", "offline"],
    versionKey: "assembly",
    description: "Monte computadores, drones, robôs, redes, satélites, rovers, circuitos e o sistema Terra–Lua por pinça, clique ou toque.",
    summary: "Oito kits, tutorial animado, profundidade assistida, pontuação e XP.",
    requirements: ["Navegador moderno", "Canvas 2D", "Câmera opcional"],
    action: { type: "mode", value: "assembly", label: "Abrir Holo Assembly" }
  },
  {
    id: "depth-trainer-web",
    name: "Depth Trainer",
    shortName: "Profundidade da mão",
    icon: "◉",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    availability: "available",
    category: "sensors",
    tags: ["sensors", "games", "education", "web", "offline"],
    versionKey: "depth",
    description: "Treine aproximação e afastamento da mão nas zonas LONGE, MÉDIO e PERTO com calibração automática.",
    summary: "Jogo de profundidade estimada com pontuação, combo e XP.",
    requirements: ["Câmera", "Uma mão visível", "Boa iluminação"],
    action: { type: "mode", value: "depth", label: "Abrir Depth Trainer" }
  },
  {
    id: "holo-sandbox-web",
    name: "Holo Sandbox",
  ...
  {
    id: "vision-scanner-web",
    name: "Vision Scanner",
    shortName: "Scanner do ambiente",
    icon: "⌗",
    platform: "web",
    delivery: "on-demand",
    offlineCapable: true,
    ...
    tags: ["sensors", "education", "games", "web", "offline"],
    versionKey: "scanner",
    description: "Reconheça objetos comuns, pessoas, cores, formas, itens segurados e ações corporais usando a câmera.",
    summary: "Inteligência visual do ambiente carregada somente quando solicitada.",
    requirements: ["Câmera", "Internet no primeiro uso do modelo", "Boa iluminação"],
    action: { type: "mode", value: "scanner", label: "Abrir scanner" }
  },
  {
