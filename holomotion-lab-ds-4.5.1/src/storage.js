const KEY = "holomotion-lab-ds:v5";
const LEGACY_KEYS = ["holomotion-lab-ds:v4", "holomotion-lab-ds:v3", "holomotion-lab-ds:v2", "holomotion-lab-ds:v1"];
