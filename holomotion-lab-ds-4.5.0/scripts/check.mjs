...
const required = [
  ...
  "src/depth-estimator.js", "src/tutorial-director.js", "src/accessibility-manager.js", "src/depth-trainer-game.js", "src/hardware-manager.js", "src/benchmark-engine.js", "src/gesture-engine.js", "src/interaction-router.js", "src/shape-game.js", "src/gesture-game.js", "src/versioning.js", "src/app-catalog.js", "src/store-ui.js",
  "src/face-engine.js", "src/body-actions.js", "src/academy-game.js", "src/sequence-game.js", "src/aura-game.js", "src/body-challenge-game.js", "src/dance-game.js", "src/stretch-game.js", "src/saber-game.js", "src/libras-game.js", "tests/gesture-engine.test.mjs", "tests/shape-game.test.mjs", "tests/versioning.test.mjs", "tests/app-catalog.test.mjs", "tests/body-actions.test.mjs", "tests/training-games.test.mjs", "tests/phase-4-1.test.mjs", "tests/phase-4-3.test.mjs", "tests/phase-4-4-1.test.mjs", "tests/phase-4-4-2.test.mjs", "tests/phase-4-4-3.test.mjs", "tests/phase-4-4-4.test.mjs", "tests/phase-4-5.test.mjs", "docs/HARDWARE_AND_BENCHMARK.md", "docs/DEPTH_AND_ACCESSIBILITY.md", "docs/LIBRAS_LAB.md", "docs/HOLO_ASSEMBLY.md", "docs/HOLO_EXPLORER.md", "docs/VISION_SCANNER.md", "downloads/LabVirtualDS-VR-v0.3.3.apk", ".nojekyll"
];
